...
--
-- Host: localhost    Database: Aurora_db
-- ------------------------------------------------------
...
CREATE TABLE `Categorias` (
  ...
  `producto_id` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `users` (
  ...
  `stade` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contry` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2019-05-28 20:23:41
